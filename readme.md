...
- GitHub: [@artoum](https://github.com/artoum)
...
1. Просто **скопируй весь текст выше**
2. Открой файл `README.md` в своём проекте
3. **Вставь скопированный текст** (замени всё содержимое)
4. Сохрани файл
5. Запушь на GitHub:

```bash
git add README.md
git commit -m "docs: update README with improved formatting"
